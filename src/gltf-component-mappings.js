...
AFRAME.GLTFModelPlus.registerComponent("my-test-element", "my-test-element");
AFRAME.GLTFModelPlus.registerComponent("switch-box", "switch-box");
AFRAME.GLTFModelPlus.registerComponent("safe-door", "safe-door");
AFRAME.GLTFModelPlus.registerComponent("safe-key", "safe-key");
AFRAME.GLTFModelPlus.registerComponent("room-door", "room-door");
